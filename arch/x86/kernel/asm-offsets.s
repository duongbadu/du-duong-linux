	.file	"asm-offsets.c"
# GNU C89 (GCC) version 6.2.1 20160830 (x86_64-pc-linux-gnu)
...
->PV_CPU_usergs_sysret64 $256 offsetof(struct pv_cpu_ops, usergs_sysret64)	#
# 0 "" 2
...
->TASK_threadsp $2592 offsetof(struct task_struct, thread.sp)	#
# 0 "" 2
# 34 "arch/x86/kernel/asm-offsets.c" 1
	
->TASK_stack_canary $1176 offsetof(struct task_struct, stack_canary)	#
# 0 "" 2
...
->TASK_addr_limit $2728 offsetof(struct task_struct, thread.addr_limit)	#
# 0 "" 2
